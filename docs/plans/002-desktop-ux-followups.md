...
- [ ] C 用户复核清单七项逐项确认并勾销。
      ...
      **T31 核心链 ✓**（双击整格 80×80 含 chip/label/空隙全通 + 换 app
      ...
      [复核进展 2026-09-11] **T37 ✓**（用户实机终验随 PLAN-611/612：外点
      /Esc 关闭 ✓、弹出位置跟手 ✓、右键标题栏先聚焦置顶 ✓——N6b 根修随
      PLAN-010 归档+链折叠 `d3527d811` 落地）。**T31 复验 ✓**（其等待的
      N6a/N6b 修复已随 PLAN-010 归档落地；同构外点关闭机制用户今日在
...
- [ ] C 用户复核七项逐项销账（T20/T24/T28/T31/T32/T37/T38）。
      ...
      提交）、T38（launcher tag 样式）两项待用户复核。**
